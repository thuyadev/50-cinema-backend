...
@section('content')
    <x-page-header-only>Edit Movie Show Time</x-page-header-only>
    ...
    <div class="grid grid-cols-12 gap-5 mt-4">
                            ...
                            <div class="relative z-0">
                                <div date-rangepicker class="flex items-center">
                                    <div class="relative">
                                        ...
                                        <input name="start_date" value="{{ $showtime['start_date'] }}" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="end_date" value="{{ $showtime['end_date'] }}" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative z-0">
                                <select name="movie_id" id="movie_id" aria-describedby=movie_id_error_help" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 focus:border-cyan-500  @error('movie_id')border-red-600 dark:border-red-500 dark:focus:border-red-500 focus:border-red-600 @enderror  appearance-none dark:text-white focus:outline-none focus:ring-0 peer">
                                    @forelse($movies as $movie)
                                        <option @if($showtime['movie_id'] == $movie['id']) selected @endif value="{{ $movie['id'] }}">{{ $movie['name'] }}</option>
                                    @empty
        ...
        <x-created-at-card-component createdAt="{{ $showtime['created_at'] }}" modifiedAt="{{ $showtime['updated_at'] }}" />
    </div>
@endsection

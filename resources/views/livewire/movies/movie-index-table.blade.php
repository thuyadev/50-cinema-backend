<div x-data="{ openDeleteModal: false, movie_id: '' }" class="dark:bg-gray-800 cinemas-table my-5 relative flex flex-col w-full min-w-0 mb-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
    <div class="px-6 py-4 mb-0 bg-gray-500/10 rounded-t-2xl flex justify-between">
        {{-- <h6 class="text-gray-300">Authors table</h6> --}}
        @livewire('movies.movie-search-imdb')
            ...
            <table class="border-collapse items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                <thead class="align-bottom">
                    <tr>
                        ...
                        <th class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-gray-200 shadow-none text-sm text-gray-300 border-b-solid tracking-none whitespace-nowrap text-slate-400">Release Date</th>
                        <th class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-gray-200 shadow-none text-sm text-gray-300 border-b-solid tracking-none whitespace-nowrap text-slate-400">Production Company</th>
                        <th class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-gray-200 shadow-none text-sm text-gray-300 border-b-solid tracking-none whitespace-nowrap text-slate-400">Movie Length</th>
                        <th class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-gray-200 shadow-none text-sm text-gray-300 border-b-solid tracking-none whitespace-nowrap text-slate-400">Language</th>
                        ...
                        <tr>
                            <td class="px-5 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex px-2 py-1">
                                    <div>
                                        <img src="{{ asset($movie['movie_poster']) }}" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 ease-soft-in-out text-size-sm h-9 w-9 rounded-xl" alt="user1" />
                                    </div>
                                    <div class="flex flex-col justify-center">
                                        <a href="{{ route('movies.show', $movie['id']) }}">
                                            <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $movie['name'] }}</h6>
                                        </a>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $movie['initial_release_date'] }}</h6>
                                </div>
                            </td>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $movie['production_company'] }}</h6>
                                </div>
                            </td>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $movie['movie_length'] }}</h6>
                                </div>
                            </td>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $movie['language'] }}</h6>
                                </div>
                            </td>
                            <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <span class="font-semibold leading-tight text-size-xs dark:text-gray-300">{{ $movie['created_at'] }}</span>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <a href="{{ route('movies.edit', $movie['id']) }}" class="font-semibold leading-tight text-size-xs dark:text-gray-300">
                                ...
                                <button @click="
                                        ...
                                        movie_id = {{ $movie['id'] }}
                                    " class="font-semibold leading-tight text-size-xs dark:text-gray-300" type="button" data-modal-toggle="popup-modal-{{ $movie['id'] }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hover:fill-current hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

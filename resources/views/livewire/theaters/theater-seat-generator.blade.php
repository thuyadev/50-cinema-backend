<div class="seats-container" x-data="{
    open_row_model: false, open_col_model: false, open: false, seat_name: '', seat_price: '', seat_type: 'normal', space_type: '', row: '', col: '', col_count: 0,
}">
...
{{--            </div>--}}
    ...
    <div class="relative mt-5 dark:bg-gray-800 py-4 px-4 transition-all shadow-none duration-250 ease-soft-in rounded-xl">
        <label class="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300" for="seats">Seats</label>
        <div role="loading" wire:loading>
            <div class="absolute top-0 left-0 right-0 bottom-0 bg-gray-900/80 flex justify-center align-middle">
                <svg class="my-auto w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-cyan-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        @if($chairs && count($chairs) > 0)
            ...
            <div class="seat-rows flex justify-center">
                <div class="mt-6 py-3 overflow-x-scroll block">
                    <div class="flex mb-3">
                        <div style="width: 9px;" class="mr-4 text-sm">R/C</div>
                        <div class="flex">
                            @for($i = 0; $i < $max_col_count; $i++)
                                <div class="w-12 mx-2 cursor-pointer hover:text-white text-center"
                                     @click.prevent="
                                        open_col_model = true
                                        col = {{ $i+1 }}
                                        seat_price = 10.00
                    ...
                    @foreach($chairs as $chair)
                        <div class="row flex mb-3">
                            <div style="width: 9px;" class="text-sm mr-4 cursor-pointer hover:text-white"
                                 @click.prevent="
                                    open_row_model = true
                                    row = '{{ $chair['name'] }}'"
                            >
                        ...
                        <div class="py-6 px-6 lg:px-8">
                            ...
                            <div class="my-4">
                                ...
                                <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center pl-3">
                                            <input id="normal" type="radio" x-model="seat_type" value="normal" name="seat_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="normal" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Normal</label>
                                        </div>
                                    </li>
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center pl-3">
                                            <input id="couple" x-model="seat_type" type="radio" value="couple" name="seat_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="couple" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Couple</label>
                                        </div>
                                    </li>
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center pl-3">
                                            <input id="wheelchair" x-model="seat_type" type="radio" value="wheelchair" name="seat_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            ...
                            <x-button @click='open = false
                                    $wire.changeSeat(row, seat_name, seat_price, seat_type, space_type)' type="button" class="w-full justify-center">Submit</x-button>
                        </div>
                    </div>
                </div>
            </div>

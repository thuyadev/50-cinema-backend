<div x-data="{ openDeleteModal: false, crew_id: '' }" class="dark:bg-gray-800 cinemas-table my-5 relative flex flex-col w-full min-w-0 mb-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
    <div class="px-6 py-4 mb-0 bg-gray-500/10 rounded-t-2xl">
        {{-- <h6 class="text-gray-300">Authors table</h6> --}}
        <div class="crew-search float-right relative">
            ...
            <table class="border-collapse items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                <thead class="align-bottom">
                    <tr>
                        ...
                        <th class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-gray-200 shadow-none text-sm text-gray-300 border-b-solid tracking-none whitespace-nowrap text-slate-400">Role</th>
                        ...
                        <tr>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $crew['name'] }}</h6>
                                </div>
                            </td>
                            <td class="px-6 py-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-gray-300">{{ $crew['role'] }}</h6>
                                </div>
                            </td>
                            <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <span class="font-semibold leading-tight text-size-xs dark:text-gray-300">{{ $crew['created_at'] }}</span>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <a href="{{ route('crews.edit', $crew['id']) }}" class="font-semibold leading-tight text-size-xs dark:text-gray-300">

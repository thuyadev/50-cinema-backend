...
@section('content')
    <x-page-header-only>Create theater</x-page-header-only>
    ...
    <div class="grid grid-cols-12 gap-5 mt-4">
        <div class="col-span-9">
            <form action="{{ route('theaters.store') }}" method="POST">
                ...
                @livewire('theaters.theater-seat-generator')
